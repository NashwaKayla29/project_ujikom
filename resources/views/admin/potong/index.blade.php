...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Potong</h4>
    <div class="card">
        <div class="card-body">
            <h4 class="card-header">Tabel potong <a href="{{ route('potong.create') }}" class="btn btn-sm btn-primary"
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @foreach ($potong as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->hasil_potong_pola }}</td>
                                    <td>{{ $data->jumlah_potong }}</td>
                                    <td>{{ \Carbon\Carbon::parse($data->tanggal_potong)->format('d F Y') }}</td>
                                    <td>
                                        <form action="{{ route('potong.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('potong.edit', $data->id) }}">
