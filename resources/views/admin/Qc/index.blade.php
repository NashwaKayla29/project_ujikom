...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Qc</h4>
    <div class="card">
        <div class="card-body">
            <h4 class="card-header">Tabel Qc <a href="{{ route('Qc.create') }}" class="btn btn-sm btn-primary"
                    ...
                    <table class="table table-bordered" id="example">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @foreach ($Qc as $data)
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>{{ $data->data_Qc->nama_Qc }}</td>
                                    <td>{{ $data->jahit->nama_barang }}</td>
                                    <td>{{ $data->lolos_Qc }}</td>
