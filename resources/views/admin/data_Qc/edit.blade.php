...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('data_Qc.update', $data_Qc->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-fullname">Nama Qc</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_Qc" value="{{$data_Qc->nama_Qc}}"
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-10">
                        <a href="{{ route('data_Qc.index') }} " class="btn btn-primary">Kembali</a>
